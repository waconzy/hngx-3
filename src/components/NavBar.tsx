			...
			<nav className='max-w-6xl mx-auto px-4 py-5 relative'>
				...
				<div className=''>
					<div className='flex items-center justify-between'>
						{/* logo */}
						<div>
							<h1 className=' font-jose text-3xl font-bold'>Olawale Gallery</h1>
						</div>
				...
				<div className={nav ? 'md:hidden relative' : ''}>
					<div
						className={
							nav
								? 'fixed left-0 top-0 w-full h-screen z-[99999] text-white bg-pink-500 p-4 ease-in duration-500'
								: 'fixed left-0 top-[-120vh] w-full h-screen z-[99999] text-white bg-pink-500 p-4 ease-out duration-500'
						}>
						<div className=''>
							{/* logo */}
							<div
